...
bool goto_symext::mock_symex_step(
  const goto_functionst &goto_functions,
  statet &state)
{
  #if 0
...
void goto_symext::micro_operator(const goto_functionst &goto_functions)
{
  goto_functionst::function_mapt::const_iterator it=
    goto_functions.function_map.find(goto_functionst::entry_point());
  ...
  const goto_programt &goto_program)
{
  ...
  if(!state_vect.empty())
  {
    state=state_vect.back();
	mock_assume_symex_step(goto_functions, state);
  }
...
bool goto_symext::mock_assume_symex_step(
  const goto_functionst &goto_functions,
  statet &state)
{
