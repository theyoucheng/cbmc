  ...
  goto_tracet &goto_trace)
{
      ...
      it++)
  {
       ...
       SSA_step.is_goto())
    {
      ...
      goto_trace_step.cond_value=prop_conv.l_get(SSA_step.cond_literal).is_true();
    }
    if(SSA_step.is_assert())
    {
     // SSA_step.cond_literal=const_literal(false); //!SSA_step.cond_literal;
      //goto_trace_step.cond_expr=not_exprt(SSA_step.cond_expr);
      goto_trace_step.cond_expr=not_exprt(SSA_step.cond_expr);
      SSA_step.cond_expr.make_not();
      SSA_step.cond_literal=!SSA_step.cond_literal;



      goto_trace_step.cond_value=prop_conv.l_get(SSA_step.cond_literal).is_true();
      std::cout << "*****goto_trace_step cond value: " << goto_trace_step.cond_value << std::endl;
    }
  }
